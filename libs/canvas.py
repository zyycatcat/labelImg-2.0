...
class Canvas(QWidget):
    ...
    def wheelEvent(self, ev):
        ...
        mods = ev.modifiers()
        # If Ctrl is pressed and there's vertical delta -> zoom
        if (mods & Qt.ControlModifier) and v_delta:
            self.zoomRequest.emit(v_delta)
        else:
            # If Shift is pressed and there's vertical delta, treat it as
            # horizontal scrolling (common UI convention).
            if (mods & Qt.ShiftModifier) and v_delta:
